...
describe "Resources Service Limes features" do

  it "GET requests project resources" do
    VCR.use_cassette "limes requesting project resources using api V1" do
  ...
  it "GET requests project resources" do
    VCR.use_cassette "limes requesting projects resources using api V1" do
  ...
  it "GET requests domain resources" do
    VCR.use_cassette "limes requesting domain resources using api V1" do
  ...
  it "GET requests domains resources" do
    VCR.use_cassette "limes requesting domains resources using api V1" do
  ...
  it "GET requests cluster resources" do
    VCR.use_cassette "limes requesting cluster resources using api V1" do
  ...
  it "GET requests current cluster resources" do
    VCR.use_cassette "limes requesting current cluster resources using api V1" do
  ...
  it "GET requests clusters resources" do
    VCR.use_cassette "limes requesting clusters resources using api V1" do
